...
// remedy [CVE-2024-37298] CWE-770: Allocation of Resources Without Limits or Throttling
replace github.com/gorilla/schema v1.1.0 => github.com/gorilla/schema v1.4.1
