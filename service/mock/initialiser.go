...
func (mock *InitialiserMock) DoGetKafkaProducer(ctx context.Context, brokers []string, topic string, maxBytes int) (kafka.IProducer, error) {
	...
	return mock.DoGetKafkaProducerFunc(ctx, brokers, topic, maxBytes)
}
